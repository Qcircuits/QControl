...
class PSAGetTrace(InstrumentTask):
    ...
    driver_list = ['RandS_FSV','AgilentPSA']
...
class GetPeakPosition(InstrumentTask):
    """Determine the frequency of the peak

    """
    task_database_entries = set_default({'peakfreq': 1.0})
    driver_list = ['RandS_FSV']
    ...
    def perform(self):
        ...
        self.write_in_database('peakfreq', self.driver.marker_peak)
...
KNOWN_PY_TASKS = [PSAGetTrace, GetPeakPosition, PSASetParam]
